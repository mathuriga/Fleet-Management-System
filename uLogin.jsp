...
<h3><center>Login to Fleet Management System to reserve the vehicle<br/>
        If you are not a user - Register <a href="do?MOD=BOK&ACT=Reg">Click Here</a> to Register with our self.</cenrer>
</h3>
